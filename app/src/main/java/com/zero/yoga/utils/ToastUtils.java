...
public class ToastUtils {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(YogoApplication.Companion.getINSTANCE().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(YogoApplication.Companion.getINSTANCE().getResources().getString(resId), args), duration);
    }
